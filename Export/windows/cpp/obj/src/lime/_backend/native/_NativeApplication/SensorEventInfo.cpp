...
bool SensorEventInfo_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void SensorEventInfo_obj::__register()
{
	...
	__mClass->mSetStaticField = &SensorEventInfo_obj::__SetStatic;
