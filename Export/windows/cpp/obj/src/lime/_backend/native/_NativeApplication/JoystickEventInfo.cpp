...
bool JoystickEventInfo_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void JoystickEventInfo_obj::__register()
{
	...
	__mClass->mSetStaticField = &JoystickEventInfo_obj::__SetStatic;
