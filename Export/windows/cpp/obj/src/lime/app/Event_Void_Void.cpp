...
{
HX_STACK_FRAME("lime.app.Event_Void_Void","new",0x6b8278e6,"lime.app.Event_Void_Void.new","lime/app/Event.hx",25,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app.Event_Void_Void","add",0x6b789aa7,"lime.app.Event_Void_Void.add","lime/app/Event.hx",36,0xbda45bec)
	HX_STACK_THIS(this)
...
bool Event_Void_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event_Void_Void","has",0x6b7de7e0,"lime.app.Event_Void_Void.has","lime/app/Event.hx",228,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(231)
	{
...
{
		HX_STACK_FRAME("lime.app.Event_Void_Void","remove",0xae858b7e,"lime.app.Event_Void_Void.remove","lime/app/Event.hx",243,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(246)
...
{
		HX_STACK_FRAME("lime.app.Event_Void_Void","dispatch",0xf4e68074,"lime.app.Event_Void_Void.dispatch","lime/app/Event.hx",133,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(135)
...
bool Event_Void_Void_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_Void_Void_obj,repeat),HX_HCSTRING("repeat","\x5b","\x97","\x7c","\x06")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_Void_Void_obj,priorities),HX_HCSTRING("priorities","\xc2","\x50","\x53","\xe4")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_Void_Void_obj,listeners),HX_HCSTRING("listeners","\x7f","\x65","\x8e","\xf3")},
	{ hx::fsUnknown, 0, null()}
};
...
void Event_Void_Void_obj::__register()
{
	...
	__mClass->mSetStaticField = &Event_Void_Void_obj::__SetStatic;
