...
bool Event_Dynamic_Void_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void Event_Dynamic_Void_obj::__register()
{
	...
	__mClass->mSetStaticField = &Event_Dynamic_Void_obj::__SetStatic;
