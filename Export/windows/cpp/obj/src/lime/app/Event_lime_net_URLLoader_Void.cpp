...
Void Event_lime_net_URLLoader_Void_obj::__construct()
{
HX_STACK_FRAME("lime.app.Event_lime_net_URLLoader_Void","new",0x2a4f6da4,"lime.app.Event_lime_net_URLLoader_Void.new","lime/app/Event.hx",25,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
//Event_lime_net_URLLoader_Void_obj::~Event_lime_net_URLLoader_Void_obj() { }

Dynamic Event_lime_net_URLLoader_Void_obj::__CreateEmpty() { return  new Event_lime_net_URLLoader_Void_obj; }
hx::ObjectPtr< Event_lime_net_URLLoader_Void_obj > Event_lime_net_URLLoader_Void_obj::__new()
{  hx::ObjectPtr< Event_lime_net_URLLoader_Void_obj > _result_ = new Event_lime_net_URLLoader_Void_obj();
	_result_->__construct();
	return _result_;}

Dynamic Event_lime_net_URLLoader_Void_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< Event_lime_net_URLLoader_Void_obj > _result_ = new Event_lime_net_URLLoader_Void_obj();
	_result_->__construct();
	return _result_;}

Void Event_lime_net_URLLoader_Void_obj::add( Dynamic listener,hx::Null< bool >  __o_once,hx::Null< int >  __o_priority){
bool once = __o_once.Default(false);
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app.Event_lime_net_URLLoader_Void","add",0x2a458f65,"lime.app.Event_lime_net_URLLoader_Void.add","lime/app/Event.hx",36,0xbda45bec)
	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC3(Event_lime_net_URLLoader_Void_obj,add,(void))

bool Event_lime_net_URLLoader_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app.Event_lime_net_URLLoader_Void","has",0x2a4adc9e,"lime.app.Event_lime_net_URLLoader_Void.has","lime/app/Event.hx",228,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(231)
	{
...
HX_DEFINE_DYNAMIC_FUNC1(Event_lime_net_URLLoader_Void_obj,has,return )

Void Event_lime_net_URLLoader_Void_obj::remove( Dynamic listener){
{
		HX_STACK_FRAME("lime.app.Event_lime_net_URLLoader_Void","remove",0xfcdfa180,"lime.app.Event_lime_net_URLLoader_Void.remove","lime/app/Event.hx",243,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(246)
...
HX_DEFINE_DYNAMIC_FUNC1(Event_lime_net_URLLoader_Void_obj,remove,(void))

Void Event_lime_net_URLLoader_Void_obj::dispatch( ::lime::net::URLLoader a){
{
		HX_STACK_FRAME("lime.app.Event_lime_net_URLLoader_Void","dispatch",0x1e739af6,"lime.app.Event_lime_net_URLLoader_Void.dispatch","lime/app/Event.hx",133,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(135)
...
HX_DEFINE_DYNAMIC_FUNC1(Event_lime_net_URLLoader_Void_obj,dispatch,(void))
...
void Event_lime_net_URLLoader_Void_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Event_lime_net_URLLoader_Void);
...
void Event_lime_net_URLLoader_Void_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic Event_lime_net_URLLoader_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Event_lime_net_URLLoader_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
...
bool Event_lime_net_URLLoader_Void_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}

void Event_lime_net_URLLoader_Void_obj::__GetFields(Array< ::String> &outFields)
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_lime_net_URLLoader_Void_obj,repeat),HX_HCSTRING("repeat","\x5b","\x97","\x7c","\x06")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_lime_net_URLLoader_Void_obj,priorities),HX_HCSTRING("priorities","\xc2","\x50","\x53","\xe4")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_lime_net_URLLoader_Void_obj,listeners),HX_HCSTRING("listeners","\x7f","\x65","\x8e","\xf3")},
	{ hx::fsUnknown, 0, null()}
};
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Event_lime_net_URLLoader_Void_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Event_lime_net_URLLoader_Void_obj::__mClass,"__mClass");
};

#endif

hx::Class Event_lime_net_URLLoader_Void_obj::__mClass;

void Event_lime_net_URLLoader_Void_obj::__register()
{
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("lime.app.Event_lime_net_URLLoader_Void","\xb2","\x0b","\x5f","\x0a");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &Event_lime_net_URLLoader_Void_obj::__SetStatic;
	__mClass->mMarkFunc = sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(sMemberFields);
	__mClass->mCanCast = hx::TCanCast< Event_lime_net_URLLoader_Void_obj >;
#ifdef HXCPP_VISIT_ALLOCS
