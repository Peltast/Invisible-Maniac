...
bool URLRequestHeader_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void URLRequestHeader_obj::__register()
{
	...
	__mClass->mSetStaticField = &URLRequestHeader_obj::__SetStatic;
