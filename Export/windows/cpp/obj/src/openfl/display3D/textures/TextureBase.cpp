...
Void TextureBase_obj::__construct(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height)
{
...
hx::ObjectPtr< TextureBase_obj > TextureBase_obj::__new(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLTexture glTexture,hx::Null< int >  __o_width,hx::Null< int >  __o_height)
