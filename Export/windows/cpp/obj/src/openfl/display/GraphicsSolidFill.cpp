...
{
HX_STACK_FRAME("openfl.display.GraphicsSolidFill","new",0x800a4bcb,"openfl.display.GraphicsSolidFill.new","openfl/display/GraphicsSolidFill.hx",44,0x9b142c07)
HX_STACK_THIS(this)
...
bool GraphicsSolidFill_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GraphicsSolidFill_obj::__register()
{
	...
	__mClass->mSetStaticField = &GraphicsSolidFill_obj::__SetStatic;
