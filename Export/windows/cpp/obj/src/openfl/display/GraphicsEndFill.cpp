...
{
HX_STACK_FRAME("openfl.display.GraphicsEndFill","new",0x1f8242bb,"openfl.display.GraphicsEndFill.new","openfl/display/GraphicsEndFill.hx",26,0x45937e97)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
bool GraphicsEndFill_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GraphicsEndFill_obj::__register()
{
	...
	__mClass->mSetStaticField = &GraphicsEndFill_obj::__SetStatic;
