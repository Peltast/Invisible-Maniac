...
bool GraphicsBitmapFill_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void GraphicsBitmapFill_obj::__register()
{
	...
	__mClass->mSetStaticField = &GraphicsBitmapFill_obj::__SetStatic;
