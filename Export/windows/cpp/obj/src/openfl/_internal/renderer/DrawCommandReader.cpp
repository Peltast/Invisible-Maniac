...
bool DrawCommandReader_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void DrawCommandReader_obj::__register()
{
	...
	__mClass->mSetStaticField = &DrawCommandReader_obj::__SetStatic;
