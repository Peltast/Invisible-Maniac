...
bool TextLayoutGroup_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	return false;
}
...
void TextLayoutGroup_obj::__register()
{
	...
	__mClass->mSetStaticField = &TextLayoutGroup_obj::__SetStatic;
