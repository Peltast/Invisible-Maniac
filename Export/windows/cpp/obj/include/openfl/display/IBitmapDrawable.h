...
virtual Void __updateTransforms( ::openfl::geom::Matrix overrideTransform) { return mDelegate->__updateTransforms(overrideTransform);}  \
virtual Dynamic __updateTransforms_dyn() { return mDelegate->__updateTransforms_dyn();}  \
