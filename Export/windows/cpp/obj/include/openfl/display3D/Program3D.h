...
class HXCPP_CLASS_ATTRIBUTES  Program3D_obj : public hx::Object{
	public:
		...
		Program3D_obj();
		Void __construct(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLProgram program);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="openfl.display3D.Program3D")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< Program3D_obj > __new(::openfl::display3D::Context3D context,::lime::graphics::opengl::GLProgram program);
